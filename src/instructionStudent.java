...
public String rollNo;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 6, -1, -1));
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-60, 70, 1420, 10));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Tahoma", 1, 25)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("During the exam:\n\n1. The student may not use his or her textbook, course notes, or receive help from a proctor or any other \noutside source.\n\n2. Students must complete the exam within the 10 mins time frame allotted \nfor the exam.\n\n3. Students must not stop the session and then return to it. This is especially important in the online \nenvironment where the system will \"time-out\" and not allow th student or you to re-enter the exam.\n\n    Exam Duration : 10 min\n    All the Best!");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 1330, 520));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 630, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
//        new quizExamStudent(rollNo,count).setVisible(true);
         quizExamStudent qes=new quizExamStudent(rollNo);
         qes.quesNumber();
         qes.setVisible(true);
