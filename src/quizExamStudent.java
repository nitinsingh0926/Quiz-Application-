...
public class quizExamStudent extends javax.swing.JFrame {
    ...
    public void answerCheck()
    {
        ...
        //last quest hiddden next quesss
        if(questionId.equals(count1))
        {
            jButton1.setVisible(false);
        }
    }
    
    public void quesNumber()
    {
     ...
     Connection con=ConnectionProvider.getCon();
            ...
            jLabel6.setText(count1+"Mins");
            jLabel15.setText(count1);
     }catch(Exception e){
    ...
    public quizExamStudent(String rollNo) {
        ...
        //question 1 and student details;
        try 
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ...
            while(rs.next())
            {
                jLabel13.setText(rs.getString(2));  //name
            }
            ResultSet rsl=st.executeQuery("select *from question where id='"+questionId+"'");
            while(rsl.next())
            {
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Questionsss???");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 180, -1, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 320, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 440, -1, -1));
        ...
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, -1, -1));
